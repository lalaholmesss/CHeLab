        ...
        <div>
            ...
            <div className="grid grid-cols-2 h-screen font-[Poppins]">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <button className="bg-[#00BF63] text-white text-xl px-[140px] py-[10px] cursor-pointer rounded-[20px]">Login</button>
                    ...
                    <p className="text-center text-sm text-black mt-6">Don't have an account? <Link to="/signup">Sign Up</Link> </p>
                </div>
